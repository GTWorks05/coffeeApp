import 'package:coffeapp/coffee_concept%202/coffee_bloc.dart';
      ...
      builder: (_, value, child) => TweenAnimationBuilder<double>(
        ...
        child: ValueListenableBuilder<bool>(
          ...
          builder: (_, value, __) => Stack(
            ...
            children: [
              Image.asset(coffee.image, fit: BoxFit.fitHeight),
              if (value)
                ShaderMask(
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: Padding(
        ...
        child: ValueListenableBuilder<bool>(
          valueListenable: bloc!.isCold,
          child: Image.asset('coffee_concept/ice.png', width: size.width * .3),
          builder: (_, value, child) => TweenAnimationBuilder<double>(
            duration: _duration,
    ...
    return ValueListenableBuilder<CoffeeSizes>(
      ...
      builder: (_, value, __) {
        return Row(
          ...
          children: [
            CoffeeSize(
              asset: 'coffee_concept/taza_s.png',
            ...
            CoffeeSize(
              asset: 'coffee_concept/taza_m.png',
            ...
            const SizedBox(width: 10),
            CoffeeSize(
              asset: 'coffee_concept/taza_l.png',
